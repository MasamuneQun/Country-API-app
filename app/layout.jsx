		...
		<html lang="en">
			<body>
				<div id="html" className="h-screen w-full flex flex-col relative">
					<div className="bg-White p-6 dark:bg-slate-900 drop-shadow-[0px_-25px_20px_#858585] dark:drop-shadow-none select-none duration-300">
					...
					<div className="w-full grow bg-LightBackground dark:bg-slate-800 duration-300">{props.children}</div>
				</div>
			</body>
		</html>
	)
